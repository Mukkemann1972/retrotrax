...
void HelpPanel::rebuild()
{
    ...
    topics.add ({ loc::t ("SID-Synthesizer", "SID synthesizer"),
        loc::t (
            ...
            "drehst. Ein SID-Ton klingt weiter (Sustain), bis du ihn mit der\n"
            ...
            "Every change plays a test C right away - you hear what you turn. A\n"
            "SID note keeps sounding (sustain) until you let it fade with key 1\n"
