...
emcc -std=c++17 -O2 \
    ...
    -sEXPORTED_FUNCTIONS='["_rtx_create","_rtx_destroy","_rtx_load_retrotrax","_rtx_load_rtx","_rtx_load_mod","_rtx_render","_rtx_buffer","_rtx_frames","_rtx_sample_rate","_rtx_tfmx_render","_rtx_stream_start","_rtx_stream_start_tfmx","_rtx_stream_render","_rtx_stream_seek","_rtx_stream_ended","_rtx_estimate_seconds","_malloc","_free"]' \
